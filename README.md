...
### 📝 &nbsp;Обо мне:
<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Я начинающий веб-девелопер<img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30px">. Мое обучение длится около 1,5 лет и продолжается каждый день. Я начинала свое обучение с простой книги для начинающих программистов об основах веб-разработки. Затем были различные курсы и интенсивы, где изучались основы C++, Java, HTML, CSS, Javascript. В процессе приобретения практических навыков определился мой интерес к веб-разработке. Мне нравится наблюдать за визуальным результатом разработки и совершенствовать его. В настоящий момент изучаю Javascript, параллельно ищу стажировку/работу и нацелена на развитие в этой сфере.</p>
